...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AWaypointAgent()
	{
		...
		if (!OuterClass)
		{
...
#endif
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_TargettWaypoint_MetaData[] = {
				{ "Category", "AI" },
				{ "ModuleRelativePath", "Public/WaypointAgent.h" },
				{ "ToolTip", "The waypoint where the actor is moving towards" },
			};
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_TargettWaypoint = { UE4CodeGen_Private::EPropertyClass::Object, "TargettWaypoint", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080000020801, 1, nullptr, STRUCT_OFFSET(AWaypointAgent, TargettWaypoint), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(NewProp_TargettWaypoint_MetaData, ARRAY_COUNT(NewProp_TargettWaypoint_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_TargettWaypoint,
	...
	IMPLEMENT_CLASS(AWaypointAgent, 3239917776);
