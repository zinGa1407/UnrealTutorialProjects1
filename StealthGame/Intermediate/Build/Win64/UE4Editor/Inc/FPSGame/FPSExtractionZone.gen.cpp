...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AFPSExtractionZone()
	{
		...
		if (!OuterClass)
		{
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ObjectiveCompletedSound = { UE4CodeGen_Private::EPropertyClass::Object, "ObjectiveCompletedSound", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080000010001, 1, nullptr, STRUCT_OFFSET(AFPSExtractionZone, ObjectiveCompletedSound), Z_Construct_UClass_USoundBase_NoRegister, METADATA_PARAMS(NewProp_ObjectiveCompletedSound_MetaData, ARRAY_COUNT(NewProp_ObjectiveCompletedSound_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_ObjectiveCompletedSound,
	...
	IMPLEMENT_CLASS(AFPSExtractionZone, 1397610609);
